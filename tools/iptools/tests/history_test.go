...
// TestNewHistoryDisabled: nil db (Mongo off) -> nil repo, nil-safe
...
func TestHistoryLiveViaHandler(t *testing.T) {
	...
	e := echo.New()
	e.Renderer = r
	iptools.Register(e, fakeLooker{res: &iptools.Result{IP: "198.51.100.23", Country: "United States", ASN: "64500"}}, hist, nil, nil)
