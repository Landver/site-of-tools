...
- Our **shipped** implementation, read as ground truth (not the design doc):
  [`botcheck/scoring.go`](../scoring.go) (the 63 detection rules),
...
`botcheck` already ships a credible client + server **consistency** scorer: 63
